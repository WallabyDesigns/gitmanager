...
class Project extends Model
{
    ...
    protected $casts = [
        ...
        'dependency_actions' => 'array',
        'custom_dependency_actions' => 'array',
        ...
        'updates_behind_count' => 'integer',
        'updates_checked_at' => 'datetime',
        'auto_deploy_blocked_at' => 'datetime',
