...
class DeploymentService
{
    ...
    private function ensureProjectHtaccess(Project $project, string $executionPath, array &$output): void
    {
        ...
        $path = $executionPath.DIRECTORY_SEPARATOR.'.htaccess';
        $label = 'Project .htaccess';
        ...
        $this->permissionService->ensureWritableDirectory($directory, $output, 'Project root directory');
        if (! is_dir($directory) || ! is_writable($directory)) {
            throw new \RuntimeException('Project root directory is not writable: '.$directory);
        }
