<x-app-layout>
    <div class="py-16">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <div class="inline-flex items-center justify-center rounded-full bg-slate-800 p-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-slate-100">{{ __('Checkout Cancelled') }}</h1>
