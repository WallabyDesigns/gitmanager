<x-app-layout>
    <div class="py-16">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <div class="inline-flex items-center justify-center rounded-full bg-emerald-500/10 p-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-slate-100">{{ __('Purchase Complete') }}</h1>
            ...
            <div class="rounded-xl border border-amber-500/30 bg-amber-500/10 p-5 text-left space-y-2">
                <div class="text-sm font-semibold text-amber-200">{{ __('Next steps') }}</div>
                <ol class="list-decimal list-inside text-xs text-amber-300 space-y-1">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                <a href="{{ route('projects.index') }}" class="inline-flex items-center rounded-md border px-4 py-2 text-sm border-slate-700 text-slate-200 hover:text-white">
                    {{ __('Back to projects') }}
                </a>
            </div>
        </div>
