<x-app-layout>
    <div class="py-16">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <div class="inline-flex items-center justify-center rounded-full bg-indigo-500/10 p-4">
                <svg class="h-10 w-10 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>

<div>
                <h1 class="text-2xl font-semibold text-slate-100">{{ __('Testing Checkout Flow') }}</h1>
            ...
            <div class="rounded-xl border border-indigo-500/30 bg-indigo-500/10 p-5 text-left space-y-2">
                <div class="text-sm font-semibold text-indigo-200">{{ __('Simulation Mode') }}</div>
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                <form method="POST" action="{{ route('checkout.enterprise.testing.complete') }}">
                    ...
                    <button type="submit" class="inline-flex items-center rounded-md border px-4 py-2 text-sm border-slate-700 text-slate-200 hover:text-white">
                        {{ __('Simulate Cancel') }}
                    </button>
                </form>
            </div>
