<x-app-layout>
    <div class="py-16">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">Testing Checkout Flow</h1>
                <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">
                    Live Stripe checkout is not configured on this installation.
                    Use this simulated flow to test Enterprise checkout UX and redirects.
                </p>
            </div>
            ...
            <div class="rounded-xl border border-indigo-300/60 bg-indigo-50/70 dark:border-indigo-500/30 dark:bg-indigo-500/10 p-5 text-left space-y-2">
                <div class="text-sm font-semibold text-indigo-800 dark:text-indigo-200">Simulation Mode</div>
                <ul class="list-disc list-inside text-xs text-indigo-700 dark:text-indigo-300 space-y-1">
                    <li>This mode is only enabled for trusted APP_KEY test installs.</li>
                    <li>No real payment is created.</li>
                    <li>“Simulate Success” will run the normal success redirect path.</li>
                </ul>
            </div>
