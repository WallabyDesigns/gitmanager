            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                @if (! $dockerAvailable && $initialSection !== 'templates')
                    <div class="rounded-xl border border-amber-200 dark:border-amber-700/50 bg-amber-50 dark:bg-amber-950/30 p-6 flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-semibold text-amber-900 dark:text-amber-200">Docker not detected</p>
                            <p class="mt-1 text-sm text-amber-700 dark:text-amber-300">Make sure Docker is installed and running on this server, and that the <code class="font-mono bg-amber-100 dark:bg-amber-900/50 px-1 rounded">GWM_DOCKER_BINARY</code> env variable points to the correct binary (default: <code class="font-mono bg-amber-100 dark:bg-amber-900/50 px-1 rounded">docker</code>).</p>
                        </div>
                    </div>
                @endif
