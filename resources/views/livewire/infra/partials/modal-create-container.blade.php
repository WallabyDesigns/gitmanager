                ...
                @if ($cliPasteMode)
                    <div class="space-y-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button wire:click="createContainerFromCli" wire:loading.attr="disabled"
                                    class="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition disabled:opacity-50">
                                <x-loading-spinner target="createContainerFromCli" />
                                {{ __('Deploy From Paste') }}
                            </button>
                            <button wire:click="parseCli"
                                    class="inline-flex items-center gap-1.5 rounded-lg border border-slate-700 px-4 py-2 text-sm font-semibold text-slate-200 hover:text-white hover:border-slate-600 transition">
                    ...
                    <div class="border-t border-slate-800 pt-4">
                        <p class="text-xs text-slate-400">{{ __('Deploy From Paste creates the container immediately. Parse & Fill Form lets you review and edit the parsed fields first.') }}</p>
                    </div>
                @endif
