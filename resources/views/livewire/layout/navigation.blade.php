...
<nav x-data="{ open: false }" x-effect="document.body.classList.toggle('overflow-hidden', open)" @keydown.escape.window="open = false" class="relative z-50 bg-white/80 dark:bg-slate-900/80 border-b border-slate-200/70 dark:border-slate-800 backdrop-blur">
    ...
    >
        ...
        ></div>
        <div
            class="absolute inset-y-0 right-0 w-80 max-w-[85vw] bg-white dark:bg-slate-900 shadow-xl border-l border-slate-200/70 dark:border-slate-800 flex flex-col"
