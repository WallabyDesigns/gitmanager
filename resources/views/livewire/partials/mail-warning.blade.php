@if (! $mailConfigured)
    <div class="rounded-xl border border-amber-300/60 p-4 text-sm text-amber-200 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <div class="text-xs uppercase tracking-wide text-amber-300">Email Not Configured</div>
            <div class="text-sm text-amber-100">Email features will not work until SMTP settings are configured.</div>
        </div>
