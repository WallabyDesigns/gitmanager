                ...
                <div class="p-6">
                    ...
                    <form wire:submit.prevent="{{ $step === 3 ? 'save' : 'nextStep' }}" class="mt-6 space-y-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                <x-input-label for="repo_url" value='{{__("Repository Address")}}' />
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        <div class="grid gap-3 sm:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <x-text-input id="ssh_root_path" class="mt-1 block w-full" wire:model.live="form.ssh_root_path" placeholder="{{ __('/home/user/public_html') }}" :disabled="! ($form['ssh_enabled'] ?? false)" />
...
<div class="rounded-lg border border-rose-500/40 bg-rose-500/10 p-4">
                        ...
                        @php
                            $rebuildType = $form['project_type'] ?? 'custom';
                            $showRebuild = in_array($rebuildType, ['static', 'node', 'react', 'nextjs'], true);
                        @endphp
                        @if ($showRebuild)
                            <div class="rounded-lg border border-slate-800 p-4">
