@php
    ...
    $currentSystemPage = match (true) {
        ...
        $isSystemTab('node') => 'App Node Runtime',
    ...
    $searchIndex = [
        ...
        // App Node Runtime
        ['label' => 'Bundled Node.js Runtime', 'section' => 'App Node Runtime', 'url' => route('system.node'), 'keys' => 'node nodejs npm javascript runtime install version path bundled app managed'],
        ['label' => 'App-managed npm', 'section' => 'App Node Runtime', 'url' => route('system.node'), 'keys' => 'npm node package manager install dependency bundled app managed'],
        // Runtime Diagnostics
        ...
        ['label' => 'System npm', 'section' => 'Runtime Diagnostics', 'url' => route('system.diagnostics'), 'keys' => 'npm path host binary system'],
        // White Label
