    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid gap-6 lg:grid-cols-[260px,1fr]">
            ...
            <div class="flex items-center gap-2">
                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100">White Label Branding</h3>
            ...
            @if ($isEnterprise)
                <p class="text-sm text-slate-500 dark:text-slate-400">Customize branding assets for your installation.</p>
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label class="text-xs uppercase tracking-wide text-slate-400 dark:text-slate-500">Brand Name</label>
                    ...
                    <div>
                        <label class="text-xs uppercase tracking-wide text-slate-400 dark:text-slate-500">Logo URL</label>
                    ...
                    <div>
                        <label class="text-xs uppercase tracking-wide text-slate-400 dark:text-slate-500">Favicon URL</label>
            ...
            @else
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    Use your own logo, brand name, and favicon with Enterprise Edition.
                </p>
