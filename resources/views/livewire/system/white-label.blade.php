    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid gap-6 lg:grid-cols-[260px,1fr]">
            ...
            @else
                ...
                <button type="button" onclick="window.dispatchEvent(new CustomEvent('gwm-open-enterprise-modal', { detail: { feature: 'White Label Branding' } }));" class="inline-flex items-center gap-2 rounded-md border px-3 py-2 text-xs font-semibold border-amber-500/60 text-amber-300 hover:text-amber-200">
